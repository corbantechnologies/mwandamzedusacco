        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
            <PopoverTrigger asChild>
              <Button className="bg-[#045138] hover:bg-[#034625] shadow-sm">
                          ...
                          >
                            ...
                            <TableCell className="sm:hidden w-full block border-none p-0 pb-2">
                              ...
                              <div className="flex justify-between items-center pt-2 border-t border-dashed mt-2">
                                ...
                                <Button
                                  ...
                                  variant="outline"
                                  size="sm"
                                  className="h-7 text-xs border-[#045138] text-[#045138]"
                                >
                                  <Link
                            ...
                            <TableCell className="hidden sm:table-cell">
                              ...
                              >
                                ...
                                >
                                  <ChevronRight className="h-4 w-4 text-gray-400 hover:text-[#045138]" />
                                </Link>
                              </Button>
                            </TableCell>
                          </TableRow>
