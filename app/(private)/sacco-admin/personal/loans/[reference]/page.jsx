                    ...
                    <div>
                        <div className="flex items-center gap-3 mb-1">
                            ...
                            <Badge
                                ...
                                className={loan.status === 'Active' ? 'bg-[#045138] text-white' : ''}
                            >
                                {loan.status}
                            </Badge>
                        </div>
                    ...
                    {activeTab === 'overview' && (
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                            ...
                            <div className="lg:col-span-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                ...
                                <Card className="border-l-4 border-l-[#045138]">
                                    ...
                                    <CardContent><p className="text-xl font-semibold text-[#045138]">{formatCurrency(loan.total_loan_amount)}</p></CardContent>
                                </Card>
                            </div>
                                    ...
                                    <TableBody>
                                        {schedule.map((item, i) => (
                                            <TableRow key={i}>
                                                ...
                                                <TableCell className="font-semibold text-[#045138]">{formatCurrency(item.total_due)}</TableCell>
