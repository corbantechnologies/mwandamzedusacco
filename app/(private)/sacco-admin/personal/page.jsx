  ...
  return (
    <div className="min-h-screen bg-gray-50/50 p-4 sm:p-6 md:p-8 space-y-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1 text-base sm:text-lg">
            Welcome back,{" "}
            <span className="font-semibold text-[#045138]">
      ...
      <div className="grid gap-4 md:gap-6 md:grid-cols-2 lg:grid-cols-3">
        <Card className="border-l-4 border-l-[#045138] hover:shadow-sm transition-shadow">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-xs font-bold uppercase tracking-wider text-slate-500">
              Total Savings
            </CardTitle>
            <PiggyBank className="h-4 w-4 text-[#045138]" />
          </CardHeader>
          <CardContent>
